...
export const translations: Translations = {
  ...
  // Schedule Page
  botAvailabilitySchedule: { en: 'Bot Availability Schedule', he: 'לוח זמנים של זמינות הבוט' },
  configureWhenBotAvailable: { en: 'Configure when the bot is available to respond to users', he: 'הגדר מתי הבוט זמין להשיב למשתמשים' },
  botCurrentlyAvailable: { en: 'Bot is Currently Available', he: 'הבוט זמין כעת' },
  botCurrentlyUnavailable: { en: 'Bot is Currently Unavailable', he: 'הבוט אינו זמין כעת' },
  weeklySchedule: { en: 'Weekly Schedule', he: 'לוח זמנים שבועי' },
  viewManageAvailability: { en: 'View and manage availability for each day of the week', he: 'צפה וניהל את הזמינות לכל יום בשבוע' },
  notConfigured: { en: 'Not configured', he: 'לא מוגדר' },
  alwaysAvailable: { en: 'Always Available', he: 'זמין תמיד' },
  neverAvailable: { en: 'Never Available', he: 'לא זמין אף פעם' },
  availabilityType: { en: 'Availability Type', he: 'סוג הזמינות' },
  always: { en: 'Always', he: 'תמיד' },
  never: { en: 'Never', he: 'לעולם לא' },
  custom: { en: 'Custom', he: 'מותאם אישית' },
  available24_7: { en: 'Available 24/7', he: 'זמין 24/7' },
  notAvailable: { en: 'Not available', he: 'לא זמין' },
  customHours: { en: 'Custom hours', he: 'שעות מותאמות אישית' },
  startTime: { en: 'Start Time', he: 'שעת התחלה' },
  endTime: { en: 'End Time', he: 'שעת סיום' },
  messageWhenUnavailable: { en: 'Message when unavailable (optional)', he: 'הודעה כשלא זמין (אופציונלי)' },
  enterMessageUnavailable: { en: 'Enter the message to send when bot is unavailable', he: 'הזן את ההודעה לשליחה כשהבוט אינו זמין' },
  leaveEmptyToIgnore: { en: 'Leave empty to silently ignore messages when unavailable', he: 'השאר ריק כדי להתעלם בשקט מהודעות כשלא זמין' },
  editSchedule: { en: 'Edit Schedule', he: 'ערוך לוח זמנים' },
  editing: { en: 'Editing', he: 'עריכה' },
  configureAvailability: { en: 'Configure availability settings for this day', he: 'הגדר הגדרות זמינות ליום זה' },
  saveSchedule: { en: 'Save Schedule', he: 'שמור לוח זמנים' },
  saving: { en: 'Saving...', he: 'שומר...' },
  resetToDefaults: { en: 'Reset to Defaults', he: 'אפס לברירות המחדל' },
  schedulesSavedSuccessfully: { en: 'Schedule saved successfully', he: 'לוח הזמנים נשמר בהצלחה' },
  schedulesInitializedToDefaults: { en: 'Schedules initialized to defaults', he: 'לוחות הזמנים אופסו לברירות המחדל' },
  failedToFetchSchedules: { en: 'Failed to fetch schedules', he: 'נכשל בהבאת לוחות הזמנים' },
  failedToSaveSchedule: { en: 'Failed to save schedule', he: 'נכשל בשמירת לוח הזמנים' },
  failedToInitializeSchedules: { en: 'Failed to initialize schedules', he: 'נכשל באתחול לוחות הזמנים' },
  startTimeBeforeEndTime: { en: 'Start time must be before end time', he: 'שעת ההתחלה חייבת להיות לפני שעת הסיום' },
  startEndTimeRequired: { en: 'Start time and end time are required for custom availability', he: 'שעת התחלה וסיום נדרשות לזמינות מותאמת אישית' },
  resetSchedulesConfirm: { en: 'This will reset all schedules to default (ALWAYS available). Continue?', he: 'זה יאפס את כל לוחות הזמנים לברירת המחדל (זמין תמיד). להמשיך?' },
